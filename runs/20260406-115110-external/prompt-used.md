...
- `runs/20260406-115110-external/progress.md`
- `runs/20260406-115110-external/intermediate/`
- `runs/20260406-115110-external/reviews/`
- `runs/20260406-115110-external/final/`

Requirements:

- Write a short chronological progress log to `runs/20260406-115110-external/progress.md`.
- Before replacing any substantial figure draft, save the prior draft in `runs/20260406-115110-external/intermediate/` using zero-padded filenames.
- Save any critic or reviewer responses in `runs/20260406-115110-external/reviews/` using zero-padded filenames.
- At the end, copy the final `PNG`, `SVG`, and notes file into `runs/20260406-115110-external/final/`.
